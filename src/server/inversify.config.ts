...
container.bind<BaseTable>(BaseTable).to(LinkedNotebookTable).whenTargetNamed("linkedNotebook");
container.bind<BaseTable>(BaseTable).to(GlobalUserTable).whenTargetNamed("globalUser");
container.bind<BaseTable>(BaseTable).to(NoteTable).whenTargetNamed("note");
container.bind<BaseTable>(BaseTable).to(NotebookTable).whenTargetNamed("notebook");
container.bind<BaseTable>(BaseTable).to(ProfitLogTable).whenTargetNamed("profitLog");
container.bind<BaseTable>(BaseTable).to(SearchTable).whenTargetNamed("search");
container.bind<BaseTable>(BaseTable).to(SettingTable).whenTargetNamed("setting");
container.bind<BaseTable>(BaseTable).to(SyncStateTable).whenTargetNamed("syncState");
container.bind<BaseTable>(BaseTable).to(TagTable).whenTargetNamed("tag");
container.bind<BaseTable>(BaseTable).to(TimeLogTable).whenTargetNamed("timeLog");
container.bind<BaseTable>(BaseTable).to(UserTable).whenTargetNamed("user");
