...
import {LinkedNotebookTable} from "../src/server/tables/linked-notebook-table";
import {NoteTable} from "../src/server/tables/note-table";
import {NotebookTable} from "../src/server/tables/notebook-table";
import {ProfitLogTable} from "../src/server/tables/profit-log-table";
import {SearchTable} from "../src/server/tables/search-table";
import {SettingTable} from "../src/server/tables/setting-table";
import {SyncStateTable} from "../src/server/tables/sync-state-table";
import {TagTable} from "../src/server/tables/tag-table";
import {TimeLogTable} from "../src/server/tables/time-log-table";
import {UserTable} from "../src/server/tables/user-table";
import {UserEntity} from "../src/common/entities/user-entity";
import {SyncStateEntity} from "../src/common/entities/sync-state-entity";
