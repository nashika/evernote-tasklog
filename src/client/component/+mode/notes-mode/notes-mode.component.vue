<template lang="pug">
  section#notes-mode.p-3
    ...
    :fields="fields", :items="lodash.values(records)", :filter="filterText")
      ...
      template(v-for="person in existPersons", :slot="'person-' + person.id", slot-scope="row")
      ...
      template(slot="FOOT_title", slot-scope="row") Total
      template(v-for="person in existPersons", :slot="'FOOT_person-' + person.id", slot-scope="row")
      ...
      template(slot="FOOT_total", slot-scope="row")
