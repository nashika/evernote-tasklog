...
(function() {
  ...
  MultiModel = (function(superClass) {
    ...
    MultiModel.prototype.s_findLocal = function(username, options, callback) {
      ...
      return core.users[username].db[this.PLURAL_NAME].find(options.query).sort(options.sort).limit(options.limit).exec((function(_this) {
    ...
    MultiModel.prototype.s_countLocal = function(username, options, callback) {
      options = this.__parseFindOptions(options);
      core.loggers.system.debug("Count local " + this.PLURAL_NAME + " was started. query=" + (JSON.stringify(options.query)));
      return core.users[username].db[this.PLURAL_NAME].count(options.query, (function(_this) {
    ...
    MultiModel.prototype.s_saveLocal = function(username, docs, callback) {
      ...
      return async.eachSeries(docs, (function(_this) {
        return function(doc, callback) {
          ...
          return core.users[username].db[_this.PLURAL_NAME].update({
            guid: doc.guid
          }, doc, {
            upsert: true
    ...
    MultiModel.prototype.s_saveLocalUpdateOnly = function(username, docs, callback) {
      if (!docs || docs.length === 0) {
        return callback();
      }
      if (!Array.isArray(docs)) {
    ...
    MultiModel.prototype.s_removeLocal = function(username, query, callback) {
      if (!query) {
        return callback();
      }
      ...
      return core.users[username].db[this.PLURAL_NAME].remove(query, {
        multi: true
      }, (function(_this) {
