...
(function() {
  ...
  MultiModel = (function(superClass) {
    ...
    MultiModel.prototype.s_findLocal = function(options, callback) {
      ...
      return core.db[this.PLURAL_NAME].find(options.query).sort(options.sort).limit(options.limit).exec((function(_this) {
    ...
    MultiModel.prototype.s_countLocal = function(options, callback) {
      ...
      return core.db[this.PLURAL_NAME].count(options.query, (function(_this) {
