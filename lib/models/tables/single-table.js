...
var SingleTable = (function (_super) {
    __extends(SingleTable, _super);
    function SingleTable() {
        _super.apply(this, arguments);
    }
    SingleTable.prototype.loadLocal = function (callback) {
        var _this = this;
        var query = { _id: 1 };
        var sort = {};
        var limit = 1;
        ...
        this._datastore.find(query).sort(sort).limit(limit).exec(function (err, docs) {
            ...
            if (err)
                return callback(err);
            var doc = docs.length == 0 ? merge(true, _this.constructor.DEFAULT_DOC) : docs[0];
            callback(null, doc);
        });
    };
    SingleTable.prototype.saveLocal = function (doc, callback) {
        var _this = this;
        doc['_id'] = 1;
    ...
    SingleTable.DEFAULT_DOC = {};
    return SingleTable;
})(table_1["default"]);
exports.__esModule = true;
exports["default"] = SingleTable;
//# sourceMappingURL=single-table.js.map