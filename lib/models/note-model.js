...
(function() {
  ...
  NoteModel = (function(superClass) {
        ...
        return function(err, notes) {
          ...
          return async.eachSeries(notes, function(note, callback) {
            if (note.content || note.hasContent) {
              ...
              return _this.loadRemote(note.guid, function(err, loadedNote) {
                if (err) {
                  return callback(err);
                }
    ...
    NoteModel.prototype._parseNote = function(note, callback) {
      var content, i, len, line, lines, ref;
      if (!note.content) {
        return callback();
      }
      ...
      return async.waterfall([
        (function(_this) {
          return function(callback) {
            return core.users[_this._username].models.timeLogs.parse(note, lines, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
