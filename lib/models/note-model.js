...
(function() {
  var MultiModel, NoteModel, ProfitLogModel, TimeLogModel, async, config, core, merge,
  ...
  NoteModel = (function(superClass) {
    ...
    function NoteModel() {
      ...
      this.s_getRemoteContent = bind(this.s_getRemoteContent, this);
    ...
    NoteModel.prototype.s_findLocal = function(username, options, callback) {
      return NoteModel.__super__.s_findLocal.call(this, username, options, (function(_this) {
    ...
    NoteModel.prototype.s_getRemoteContent = function(username, options, callback) {
      options = merge(true, options, {
        content: true
      });
      return this.s_findLocal(username, options, (function(_this) {
        return function(err, notes) {
          var result;
          if (err) {
            return callback(err);
          ...
          return async.eachSeries(notes, function(note, callback) {
            ...
            return _this.s_loadRemote(username, note.guid, function(err, loadNote) {
              if (err) {
                return callback(err);
              }
    ...
    NoteModel.prototype.s_loadRemote = function(username, guid, callback) {
      ...
      return async.waterfall([
        (function(_this) {
          ...
          return function(note, callback) {
            ...
            return core.users[username].db.notes.update({
              guid: note.guid
            }, note, {
              upsert: true
            }, callback);
          ...
          return function(callback) {
            return _this.s_parseNote(username, lastNote, callback);
          };
        })(this)
      ], (function(_this) {
        return function(err) {
    ...
    NoteModel.prototype.s_parseNote = function(username, note, callback) {
      ...
      return async.series([
        (function(_this) {
          return function(callback) {
            return TimeLogModel.prototype.s_removeLocal(username, {
              noteGuid: note.guid
            }, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
            return ProfitLogModel.prototype.s_removeLocal(username, {
              noteGuid: note.guid
            }, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
            return TimeLogModel.prototype.s_saveLocal(username, timeLogs, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
            return ProfitLogModel.prototype.s_saveLocal(username, profitLogs, callback);
          };
        })(this)
      ], (function(_this) {
        return function(err) {
