...
(function() {
  ...
  NoteModel = (function(superClass) {
    ...
    NoteModel.prototype.s_findLocal = function(options, callback) {
      return NoteModel.__super__.s_findLocal.call(this, options, (function(_this) {
    ...
    NoteModel.prototype.s_getRemoteContent = function(options, callback) {
      options = merge(true, options, {
        content: true
      });
      return this.s_findLocal(options, (function(_this) {
        return function(err, notes) {
          var result;
          if (err) {
            return callback(err);
    ...
    NoteModel.prototype.s_parseNote = function(note, callback) {
      ...
      return async.series([
        (function(_this) {
          return function(callback) {
            return TimeLogModel.prototype.s_removeLocal({
              noteGuid: note.guid
            }, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
            return ProfitLogModel.prototype.s_removeLocal({
              noteGuid: note.guid
            }, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
            return TimeLogModel.prototype.s_saveLocal(timeLogs, callback);
          };
        })(this), (function(_this) {
          return function(callback) {
            return ProfitLogModel.prototype.s_saveLocal(profitLogs, callback);
          };
        })(this)
      ], (function(_this) {
        return function(err) {
