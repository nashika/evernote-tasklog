...
export default class Model {
    ...
    constructor(username:string = '') {
        if ((<typeof Model>this.constructor).REQUIRE_USER && !username) {
        ...
        this._datastore = new Datastore({
            filename: dbPath + inflection.transform((<typeof Model>this.constructor).PLURAL_NAME, ['underscore', 'dasherize']) + '.db',
            autoload: true
        });
    }
