...
(function() {
  var MultiModel, TimeLogModel, async, core, moment,
  ...
  TimeLogModel = (function(superClass) {
    ...
    TimeLogModel.prototype.parse = function(note, lines, callback) {
      var attributesText, dateText, i, j, len, len1, line, matches, person, ref, spentHour, spentMinute, spentTimeText, timeLog, timeLogs, timeText;
      timeLogs = [];
      for (i = 0, len = lines.length; i < len; i++) {
        ...
        if (matches = line.match(/(.*)[@＠](\d{2,4}[\/\-]\d{1,2}[\/\-]\d{1,2}.+)/)) {
          ...
          ref = core.users[this._username].settings.persons;
