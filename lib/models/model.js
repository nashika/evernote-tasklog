...
(function() {
  ...
  Model = (function() {
    function Model() {
      ...
      this.s_find = bind(this.s_find, this);
    }
    ...
    Model.prototype.s_find = function(query, callback) {
      merge(query, {
        deleted: null
      });
      return core.db[this.PLURAL_NAME].find(query).sort({
        updated: -1
