...
(function() {
  ...
  DataSource = (function() {
        ...
        (function(_this) {
          ...
          return function(callback) {
            ...
            return async.whilst((function() {
              ...
              return async.waterfall([
                function(callback) {
                  return noteStore.getFilteredSyncChunk(localSyncState.updateCount, 3, syncChunkFilter, callback);
    ...
    DataSource.prototype._saveLocalNotes = function(notesMeta, callback) {
      var noteStore;
      noteStore = core.client.getNoteStore();
