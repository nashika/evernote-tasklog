...
(function() {
  var Evernote, LinkedNotebookModel, NoteModel, NotebookModel, ProfitLogsModel, SearchModel, SettingModel, SyncStateModel, TagModel, TimeLogsModel, UserModel, Www, async, core, log4js, path,
  ...
  Www = (function() {
      ...
      return async.waterfall([
        (function(_this) {
          return function(callback) {
            return core.models.settings.loadLocal(null, callback);
          };
        })(this), (function(_this) {
    ...
    Www.prototype.sync = function(username, callback) {
      ...
      return async.waterfall([
        (function(_this) {
          return function(callback) {
            return core.users[username].models.settings.loadLocal(null, callback);
          };
        })(this), (function(_this) {
          return function(settings, callback) {
